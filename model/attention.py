...
class Attention(nn.Module):
    ...
    def __init__(self, config: Config, hidden_dim, hidden_level, out_dim, is_time_conditioned = False): 
        ...
        self.multihead_attn = nn.MultiheadAttention(embed_dim, num_heads, batch_first=True, kdim=kv_dim, vdim=kv_dim, add_bias_kv=True, dropout=0.2) #, add_bias_kv=True, dropout=0.2
